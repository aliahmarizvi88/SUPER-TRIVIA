...
const ScoresPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-6 px-2 sm:py-10 sm:px-4">
      <div className="max-w-4xl mx-auto bg-white p-4 sm:p-8 rounded shadow">
            ...
            <table className="w-full text-left border-collapse text-xs sm:text-base">
              <thead>
                <tr className="bg-gray-200">
                  <th className="p-2 sm:p-3 border-b">Player</th>
                  <th className="p-2 sm:p-3 border-b">Score</th>
                  <th className="p-2 sm:p-3 border-b">Category</th>
                  <th className="p-2 sm:p-3 border-b">Difficulty</th>
              ...
              <tbody>
                {score.map((entry) => (
                  <tr key={entry._id} className="hover:bg-gray-50">
                    <td className="p-2 sm:p-3 border-b">{entry.playerName}</td>
                    ...
                    <td className="p-2 sm:p-3 border-b capitalize">
                      {entry.difficulty}
                    </td>
                    <td className="p-2 sm:p-3 border-b text-xs text-gray-500">
        ...
        <div className="text-center mt-6">
          <button
            className="bg-indigo-600 text-white px-4 sm:px-6 py-2 rounded hover:bg-indigo-700"
            onClick={() => navigate('/')}
          >
            Back to Home
          </button>
